        ...
        <div className="bg-linear-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2
              ...
              data-aos="fade-up"
            >
              Powering Your Future — Responsibly and With Ease
            </h2>
            <p 
              className="mx-auto max-w-2xl text-lg text-indigo-200/65 pb-8"
              data-aos="fade-up"
              data-aos-delay={200}
            >
              Let’s build a smarter, greener, and more secure digital future together. Partner with Careez IT Sol and experience technology that truly supports your business.
            </p>
