...
const testimonials = [
  {
    ...
    content:
      "“Careez IT Sol transformed our IT infrastructure. Zero downtime and exceptional support — exactly what we needed.”",
  ...
  },
  {
    ...
    content:
      "“Their cybersecurity expertise gave us complete peace of mind. Professional, responsive, and highly skilled.”",
    categories: [1, 2, 3, 4, 5],
  },
  {
    ...
    content:
      "“The Green IT and LEED consulting helped us reduce energy costs and meet sustainability goals faster than expected.”",
    categories: [1, 2, 3, 4, 5],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Businesses trust Careez IT Sol for secure, reliable, and sustainable technology solutions. Here’s what our clients say about partnering with us.
          </p>
        </div>
