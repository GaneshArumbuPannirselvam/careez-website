  ...
  return (
    <footer>
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center justify-between gap-6 py-8 text-center md:flex-row md:py-12 md:text-left">
          {/* Left Block: Logo, Tagline, Location */}
          ...
          {/* Right Block: Contact info, Copyright & Socials */}
          <div className="flex flex-col items-center space-y-3 md:items-end">
            <p className="text-sm text-indigo-200/65">
              Email:{" "}
              <a 
                href="mailto:info@careezitsol.com" 
                className="text-indigo-400 transition hover:text-indigo-300"
              >
                info@careezitsol.com
              </a>
            </p>
            
            <div className="text-sm text-indigo-200/65">
              <span>© 2024 Careez IT Sol. All rights reserved.</span>
            </div>
